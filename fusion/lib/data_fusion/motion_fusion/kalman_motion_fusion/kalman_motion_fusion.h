...
class KalmanMotionFusion : public BaseMotionFusion {
 ...
 private:
  ...
  void RewardRMatrixObu(const base::SensorType& sensor_type,
                        const bool& converged,
  ...
  Eigen::Vector4d ComputePseudoObuMeasurement(const Eigen::Vector4d& measurement);

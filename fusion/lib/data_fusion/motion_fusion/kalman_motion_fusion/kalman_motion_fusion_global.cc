...
#include "kalman_motion_fusion_global.h"
...
int KalmanMotionFusionGlobal::s_eval_window_ = 3;
size_t KalmanMotionFusionGlobal::s_history_size_maximum_ = 20;

bool KalmanMotionFusionGlobal::Init() {
...
bool KalmanMotionFusionGlobal::InitFilter(const SensorObjectConstPtr& sensor_object) {
...
void KalmanMotionFusionGlobal::GetStates(Eigen::Vector3d* anchor_point, Eigen::Vector3d* velocity) {
  *anchor_point = fused_anchor_point_;
  *velocity = fused_velocity_;
}

void KalmanMotionFusionGlobal::UpdateWithoutMeasurement(const std::string& sensor_id,
...
void KalmanMotionFusionGlobal::UpdateWithMeasurement(const SensorObjectConstPtr& measurement,
                                                     double target_timestamp) {
...
void KalmanMotionFusionGlobal::MotionFusionWithoutMeasurement(const double time_diff) {
...
void KalmanMotionFusionGlobal::MotionFusionWithMeasurement(const SensorObjectConstPtr& measurement,
                                                           double time_diff) {
...
void KalmanMotionFusionGlobal::UpdateMotionState() {
...
Eigen::VectorXd KalmanMotionFusionGlobal::ComputeAccelerationMeasurement(
...
void KalmanMotionFusionGlobal::RewardRMatrix(const base::SensorType& sensor_type,
...
Eigen::Vector4d KalmanMotionFusionGlobal::ComputePseudoMeasurement(
...
Eigen::Vector4d KalmanMotionFusionGlobal::ComputePseudoLidarMeasurement(
    const Eigen::Vector4d& measurement) {
...
Eigen::Vector4d KalmanMotionFusionGlobal::ComputePseudoCameraMeasurement(
    const Eigen::Vector4d& measurement) {
  // Initialize status variables
  int trace_count = 0;
...
Eigen::Vector4d KalmanMotionFusionGlobal::ComputePseudoRadarMeasurement(
    const Eigen::Vector4d& measurement) {
  // Initialize status variables
...
void KalmanMotionFusionGlobal::UpdateSensorHistory(const base::SensorType& sensor_type,
                                                   const Eigen::Vector3d& velocity,
                                                   const double& timestamp) {
...
int KalmanMotionFusionGlobal::GetSensorHistoryLength(const base::SensorType& sensor_type) {
...
int KalmanMotionFusionGlobal::GetSensorHistoryIndex(const base::SensorType& sensor_type,

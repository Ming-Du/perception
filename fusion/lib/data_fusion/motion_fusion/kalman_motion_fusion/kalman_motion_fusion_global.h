...
class KalmanMotionFusionGlobal : public BaseMotionFusion {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

 public:
  explicit KalmanMotionFusionGlobal(TrackPtr track) : BaseMotionFusion(track) {}
  ~KalmanMotionFusionGlobal() = default;

  KalmanMotionFusionGlobal(const KalmanMotionFusionGlobal&) = delete;
  KalmanMotionFusionGlobal& operator=(const KalmanMotionFusionGlobal&) = delete;

...
double ComputePtsBoxLocationSimilarity(const ProjectionCachePtr& cache,
                                       ...
                                       const fusion::BBox2DF& camera_bbox) {
  ...
  if (object->Empty()) {
    ROS_DEBUG("ComputePtsBoxLocationSimilarity: cache object is empty!");
    return min_p;
  }
  ...
  for (size_t i = start_ind; i < end_ind; ++i) {
    ...
    if (velo_pt2d == nullptr) {
      ROS_ERROR("ComputePtsBoxLocationSimilarity: query pt from projection cache failed!");
      continue;
    }
  ...
  ROS_DEBUG_STREAM("ComputePtsBoxLocationSimilarity: mean_pixel_dist is: " << mean_pixel_dist);
...
double ComputePtsBoxShapeSimilarity(const ProjectionCachePtr& cache,
  ...
  fusion::BBox2DF velo_projection_bbox = object->GetBox();
  ...
  ROS_DEBUG_STREAM("ComputePtsBoxShapeSimilarity: camera_box_size@("
                   << camera_box_size(0) << "," << camera_box_size(1) << "); "
...
double ComputePtsBoxSimilarity(const ProjectionCachePtr& cache,
  ...
  ROS_DEBUG_STREAM("ComputePtsBoxSimilarity: fused_similarity@"
                   << fused_similarity << ", location_similarity@" << location_similarity

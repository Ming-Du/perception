...
// ############################################
//
// model_config_path: "src/perception/production/conf/frame_classifier.config"
// model_config_path: "src/perception/production/conf/track_classifier.config"
//
// ############################################
//
...
#include "perception/lib/thread/mutex.h"
#include "common/proto/perception_config_schema.pb.h"
...
class ModelConfig {
 public:
  ...
  bool Reset(const perception::ModelConfigProto &proto);

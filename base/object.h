...
// #include "perception/base/object_supplement.h"
// #include "modules/perception/base/object_types.h"
// #include "modules/perception/base/point_cloud.h"
// #include "modules/perception/base/vehicle_struct.h"
// #include "modules/prediction/proto/feature.pb.h"
// #include "perception/base/proto/sensor_frame.pb.h"
...
template<typename T>
Eigen::Matrix<T, 3, 1> PointToEigenVector(::geometry::Point point3d) {
  return Eigen::Matrix<T, 3, 1>(point3d.x(), point3d.y(), point3d.z());
}
template<typename T>
Eigen::Matrix<T, 3, 1> PointToEigenVector(::geometry::Vector3 point3d) {
  return Eigen::Matrix<T, 3, 1>(point3d.x(), point3d.y(), point3d.z());
}
...
using Object = ::perception::Object;

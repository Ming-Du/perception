...
# Usage:
#   rs_perception_list_unique(<list_variable> [<list_variable>] [...])
macro(rs_perception_list_unique)
    foreach(__lst ${ARGN})
        if(${__lst})
...
set(Rs_perception_known_gpu_archs "72")

################################################################################################
# A function for automatic detection of GPUs installed  (if autodetection is enabled)
# Usage:
#   rs_perception_detect_installed_gpus(out_variable)
function(rs_perception_detect_installed_gpus out_variable)
  ...
  if(NOT CUDA_gpu_detect_output)
    ...
    set(${out_variable} ${Rs_perception_known_gpu_archs} PARENT_SCOPE)
  else()
...
# Usage:
#   rs_perceptioon_select_nvcc_arch_flags(out_variable)
function(rs_perception_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${Rs_perception_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(__cuda_arch_bin ${Rs_perception_known_gpu_archs})
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    rs_perception_detect_installed_gpus(__cuda_arch_bin)
  ...
  rs_perception_list_unique(__cuda_arch_bin __cuda_arch_ptx)
...
# Usage:
#   rs_perception_cuda_compile(<objlist_variable> <cuda_files>)
macro(rs_perception_cuda_compile objlist_variable)
...
list(APPEND RS_PERCEPTION_GPU_INCLUDE_DIRS ${CUDA_INCLUDE_DIRS})
# list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CUDA_LIBRARIES})
list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CUDA_LIBRARIES})

# cudnn detection
detect_cuDNN()
if(HAVE_CUDNN)
  list(APPEND RS_PERCEPTION_GPU_INCLUDE_DIRS ${CUDNN_INCLUDE})
  # list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CUDNN_LIBRARY})
  list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CUDNN_STATIC_LIBRARY})
endif()
...
if(EXISTS ${CUBLAS_STATIC_LIBRARY})
  list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CUBLAS_STATIC_LIBRARY})
endif()
if(EXISTS ${CULIBOS_STATIC_LIBRARY})
  list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS ${CULIBOS_STATIC_LIBRARY})
endif()
list(APPEND RS_PERCEPTION_GPU_LINKER_LIBS dl)
# setting nvcc arch flags
rs_perception_select_nvcc_arch_flags(NVCC_FLAGS_EXTRA)
